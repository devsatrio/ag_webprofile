          ...
          <section class="wrapper">
              ...
              <section class="panel">
                  ...
                  <form method="post" action="<?= base_url("admin/jamak/do_tambah")?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                   		<button type="submit" class="btn btn-success"> Tambah</button> <a href="<?= base_url("admin/halaman")?>" class="btn btn-warning">Batal</a>
                    </div>
                    </form>
                  </div>
                            <table class="table">
								...
								foreach($jamak as $jamak){?>
                                    ...
                                    <td>
                                    <a href="<?= base_url("admin/jamak/edit/".$jamak->id_majemuk."/".$id_jamak)?>" class="btn btn-xs btn-warning">Edit</a>
                                    <a href="<?= base_url("admin/jamak/hapus/".$jamak->id_majemuk)?>" onclick="return hapus($(this));" class="btn btn-xs btn-danger">Hapus</a>
                                    </td>
                                    </tr>
								<?php $no++;}?>
                                </tbody>
