...
<head>
    ...
    <script type="text/javascript" language="javascript" src="<?= base_url();?>tpl_admin/assets/advanced-datatable/media/js/jquery.dataTables.js"></script>
...
<body>
    ...
    <section id="container" class="">
        ...
        <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo">DASH<span>BOARD</span></a>
            <!--logo end-->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li alignt="center"><a href="<?= base_url("admin/gantiPass")?>">Edit password</a></li>
