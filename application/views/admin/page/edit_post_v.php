              ...
              <section class="panel">
                  ...
                  <div class="panel-body" style="min-height:500px;">
                    ...
                    <div class="row">
                        ...
                        <div class=" col-lg-4">
                        <label>Tanggal</label>
                    	<input type="text" class="form-control default-date-picker" name="tanggal" value="<?= $this->master->get_date($data->tanggal)?>" />
                        </div>
                    </div>
                    <div class="row">
                    	<div class="col-lg-4">
                    ...
                    <div class="form-group">
                    	<label>Isi</label>
                    	<textarea class="form-control ckeditor" name="isi" rows="15"><?= $data->isi?></textarea>
					</div>
                    <div class="form-group">
